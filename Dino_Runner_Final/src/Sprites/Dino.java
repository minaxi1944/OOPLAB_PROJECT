...
public class Dino {
	...
	public Dino() {
		...
		charrun.addFrame(Resource.getResourceImage("Images/dino01.png"));
		charrun.addFrame(Resource.getResourceImage("Images/dino02.png"));
		rect = new Rectangle();
		
		charduck = new Animation(200);
		charduck.addFrame(Resource.getResourceImage("Images/dino_duck_01.png"));
		charduck.addFrame(Resource.getResourceImage("Images/dino_duck_02.png"));
	...
	public void draw(Graphics g) {
		...
		switch(state) {
			case CHAR_RUN:
			g.drawImage(charrun.getFrame(),(int)x,(int)y-14,charrun.getFrame().getWidth(),charrun.getFrame().getHeight(),null);
			//g.drawRect((int)x,(int)y-10, charrun.getFrame().getWidth(), charrun.getFrame().getHeight());
			//g.drawRect((int)x,(int)y-25, charrun.getFrame().getWidth(), charrun.getFrame().getHeight());
			
			break;
			
			case CHAR_DUCK:
			g.drawImage(charduck.getFrame(),(int)x,(int)y,charrun.getFrame().getWidth(),charrun.getFrame().getHeight(),null);
	...
	public void jump() {
		speed = -13;							//on press the dino jumps
		y = y + speed;
