...
public class GameScreen extends JPanel implements Runnable, KeyListener {
	...
	private BufferedImage imageGameOver,highscore, imageJump, imageDuck;
	private int score;
	...
	public void paint(Graphics g) {
		BufferedImage backg1 = Resource.getResourceImage("images/gameplay6.jpg");
		BufferedImage backg2 = Resource.getResourceImage("images/gameplay7.jpg");
		BufferedImage backg3= Resource.getResourceImage("images/gameplay2.jpg");
		BufferedImage start= Resource.getResourceImage("images/startgame.png");
		imageJump = Resource.getResourceImage("images/jump.png");
		imageDuck = Resource.getResourceImage("images/duck.png");
		
		if(score<100) {
			g.drawImage(backg1,0,0,backg1.getWidth()-320,backg1.getHeight()-320,null);
			...
			if(score>ScoreFile.read_from_file())
			{
				g.drawImage(backg2,0,0,backg2.getWidth()-320,backg2.getHeight()-350,null);
		land.draw(g);
			c.draw(g);
			}
			else {
				g.drawImage(backg3,0,0,backg3.getWidth()-320,backg3.getHeight()-320,null);
				land.draw(g);
					c.draw(g);
			}
		}
		...
		switch(gameState) {
			case START_GAME_STATE:
				dino.draw(g);
				g.drawImage(start,140,10,null);
				g.drawImage(imageJump,200,40,null);
				g.drawImage(imageDuck,380,40,null);
				break;
			...
			case GAMEPLAY_STATE:		//draw obstacles and dino during running game
				...
				g.drawString("HIGHEST SCORE: "+ ScoreFile.read_from_file(), 490, 20);
				g.drawString("SCORE: " + String.valueOf(score), 690, 20);		//display score on game screen
				break;
			...
			case GAME_OVER_STATE:
				...
				g.drawString("HIGHEST SCORE " + ScoreFile.read_from_file(), 490, 20);
				g.drawString("SCORE " + String.valueOf(score), 690, 20);		//display score on game screen
				g.drawImage(imageGameOver, 340, 40 ,100,100, null);
				break;
		}
	}
