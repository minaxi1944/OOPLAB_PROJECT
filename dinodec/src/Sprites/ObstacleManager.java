...
public class ObstacleManager<GameScreen> {
	...
	private Random random, randomObstacle;
	...
	public ObstacleManager(Dino dino, GameScreen gameScreen) {
		...
		imageSpookiz = Resource.getResourceImage("images/bird.png");
		random = new Random();
		//obstacles.add(getRandomCactus());	//add cactus to the list
		obstacles.add(getBird());
	}
	
	public void draw(Graphics g) {			//draw obstacle from the list, in the game
